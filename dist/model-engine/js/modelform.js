...
define(function(require, exports, module) {
    var $ = jQuery = require('jquery'),
        ...
        eve = require('/model-engine/js/event'),
    ...
    $LAB
    .script('/libs/jquery-validation-1.11.1/jquery.validate.js').wait()
    .script('/libs/jquery-validation-1.11.1/localization/messages_zh.js');
    ...
    function ModelForm(id, name, options, def){
         ...
         * 拉取表单配置数据的服务器端服务
         **/
        this.dynamic_fetch_service = '/model-engine/svr/model_form_fetch.php';
        this.static_fetch_service = '';
        ...
        this.options = $.extend({
            ...
            */
            'def_name': 'name',
            // 接收表单提交数据的服务器端服务
            'action_service': '/model-engine/svr/model_form_save.php',
            'placeholder': '', 
            'fixedfields': {}
        }, options);
    ...
    $.extend(ModelForm.prototype, EventDispatcher.prototype, {
         ...
         */
        load: function(data){
            $.getJSON(this.dynamic_fetch_service, data, $.proxy(this.initialise, this));
        },
        ...
        createItem: function(container, settings, inline){
            ...
            create(this, container, settings, 
                { 'inline': inline, 'createItem': $.proxy(this.createItem, this) }, 
                def);
        },
