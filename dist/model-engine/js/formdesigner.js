...
define(function(require, exports, module) {
    var $ = jQuery = require('jquery'),
        ...
        mel = require('/model-engine/js/modeleditablelist'),
        mcl = require('/model-engine/js/modelctrllist'),
    ...
    function FormDesigner(form, attribute, validation){
        ...
        this.delete_service = '/model-engine/svr/model_delete.php';
        this.list_service = '/model-engine/svr/model_list_fetch.php';
    };
