    ...
    copy:{
      main:{
        files: [
          ...
          {expand: true, cwd: "libs/php-db-0.1.1/dist/inc", src: ["**"], dest: "dist/demo/inc"},
          {expand: true, cwd: "libs/php-site-core-0.1.1/dist/inc", src: ["**"], dest: "dist/demo/inc"},
          ...
          {expand: true, cwd: "libs/php-db-0.1.1/dist/inc", src: ["**"], dest: "dist/dependencies/inc"},
          {expand: true, cwd: "libs/php-site-core-0.1.1/dist/inc", src: ["**"], dest: "dist/dependencies/inc"},
