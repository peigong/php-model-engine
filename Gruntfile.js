    ...
    copy:{
      main:{
        files: [
          ...
          {expand: true, cwd: "libs/php-db-0.0.2/dist/inc", src: ["**"], dest: "dist/demo/inc"},
          {expand: true, cwd: "libs/php-site-core-0.0.2/dist/inc", src: ["**"], dest: "dist/demo/inc"},
          ...
          {expand: true, cwd: "libs/php-db-0.0.2/dist/inc", src: ["**"], dest: "dist/dependencies/inc"},
          {expand: true, cwd: "libs/php-site-core-0.0.2/dist/inc", src: ["**"], dest: "dist/dependencies/inc"},
          ...
          {expand: true, cwd: "libs/bootstrap-v3.0.0-rc1/dist", src: ["**"], dest: "dist/dependencies/libs/bootstrap-v3.0.0-rc1"},
